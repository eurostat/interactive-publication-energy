...
/*!*************************************************************************************************!*\
  !*** /Users/Marc/Documents/digital_publication/infography/stacked_bar/configs/configuration.js ***!
  \*************************************************************************************************/
...
/***/ "../../configs/energy/energy_03_01_01/indicator.js":
/*!********************************************************************************************************************!*\
  !*** /Users/Marc/Documents/digital_publication/infography/stacked_bar/configs/energy/energy_03_01_01/indicator.js ***!
  \********************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
module.exports = {
  visData: [{
    ...
    "table": "nrg_bal_s",
    "params": {
      //nrg_bal_s?siec=C0000X0350-0370&siec=C0350-0370&siec=E7000&siec=G3000&siec=H8000&siec=N900H&siec=O4000XBIO&siec=P1000&siec=RA000&siec=S2000&siec=TOTAL&siec=W6100_6220&precision=1&unit=KTOE&nrg_bal=FC_E
      "siec": ["TOTAL", "C0000X0350-0370", "C0350-0370", "E7000", "G3000", "H8000", "N900H", "O4000XBIO", "P1000", "RA000", "S2000", "W6100_6220"],
      "unit": ["KTOE"],
      "nrg_bal": ["FC_E"],
      "precision": ["1"]
    },
    "grouping": _defineProperty({
      "process": "TOTAL%",
      "paramName": "siec",
      "default": "petroleum_products",
      "groups": [{
        "code": "petroleum_products",
        "elems": ["O4000XBIO"],
        "title": "petroleum_products.title",
        "color": "#193769"
      }, {
        "code": "electricity",
        "elems": ["E7000"],
        ...
        "code": "natural_gas",
        "elems": ["G3000", "C0350-0370"],
        "title": "natural_gas.title",
        "color": "#F79416"
      }, {
        ...
        "code": "derived_heat",
        "elems": ["H8000"],
        "title": "derived_heat.title",
        "color": "#F6B295"
      }, {
        "code": "solid_fuel",
        "elems": ["C0000X0350-0370", "P1000", "S2000", "W6100_6220"],
        "title": "solid_fuel.title",
        "color": "#8E3F23"
      }]
    }, "process", "TOTAL%"),
    "code": "EN_03_01_01",
    ...
    if (valuesArr["type"] == "list") {
      ...
      sel.on("change", function () {
        ...
        jQuery.when(Object(_dataservice__WEBPACK_IMPORTED_MODULE_1__["default"])(window.categorySelected)).done(function () {
          Object(_main__WEBPACK_IMPORTED_MODULE_6__["processData"])(window.categorySelected, _main__WEBPACK_IMPORTED_MODULE_6__["currentSorting"]);
        });
      });
...
var appData = __webpack_require__(/*! ../../../configs/energy/energy_03_01_01/indicator.js */ "../../configs/energy/energy_03_01_01/indicator.js");
...
window.currentId = "energy_03_01_01";
...
$(function () {
  ...
  var callback = function callback() {
    ...
    processData(currentCategory, currentSorting);
  };
...
function initSortingCheckboxes() {
  ...
  $("#chartSort ul li a").click(function () {
    ...
    currentSorting = code;
    processData(window.categorySelected, currentSorting);
  });
...
function processData(category, sort) {
  ...
  constants.countriesGroupped.forEach(function (arrayCountries) {
    ...
    if (arrayCountriesWithoutRemove.length > 0) {
      ...
      arrayDataTmp = arrayDataTmp.filter(function (el) {
        return indicators[category].countries2Remove.indexOf(el.Geo) < 0;
      });
  ...
  if (indicators[currentCategory].UISortGroup == "checkbox") {
    ...
    legendItems = {
      onclick: function onclick(id) {
        ...
        processData(window.categorySelected, currentSorting, selectedSortDirection);
...
/******/ });
//# sourceMappingURL=stackedbarchart.7a97ebd744c534d05acc.js.map